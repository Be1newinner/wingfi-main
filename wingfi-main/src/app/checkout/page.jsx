...
export const AddressItem = ({ id, addressSelected, setAddressSelected }) => {
  return (
    <div
      className={[
        "flex p-6 gap-4 items-start cursor-pointer border-t-2",
    ...
    >
      ...
      <div className="flex flex-col flex-1 text-sm gap-2">
        ...
        {addressSelected === id && (
          <div>
            <button className="btn btn-error mt-2 text-white text-xs font-medium px-12 py-4 rounded-none">
              DELIVER HERE
            </button>
          </div>
        )}
