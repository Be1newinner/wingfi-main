...
export function* rootSaga() {
  yield all([
    ...
    rateCardSagaWatcher(),
    getLogWatcher(),
    searchContactDetailWatcher(),
    getContactDetailsWatcher(),
    addContactDetailsSagaWatcher(),
    addContactTypeWatcher(),
    deleteContactTypeWatcher(),
    updateContactTypeSagaWatcher(),
    getContactTypeWatcher(),
    getDashboardOverviewWatcher(),
  ]);
}
